...
def vent_table(vrs_num, vrs_perf, vosk):
    ...
    vent_list = {
        ...
        '115' + '5.0': sheet_form['A48':'D39'],
        '115' + '5.6': sheet_form['F48':'I49'],
        '115' + '6.3': sheet_form['K48':'N49'],
        '116' + '4.5': sheet_form['A53':'D54'],
        '116' + '5.0': sheet_form['F53':'I54'],
        '116' + '5.6': sheet_form['K53':'N54'],
        '116' + '6.3': sheet_form['P53':'S54'],
        '138' + '4.5': sheet_form['A58':'D59'],
        '138' + '5.0': sheet_form['F58':'I59'],
        '138' + '5.6': sheet_form['K58':'N59'],
        '138' + '6.3': sheet_form['P58':'S59'],
        '156' + '5.6': sheet_form['A63':'D64'],
        '156' + '6.3': sheet_form['F63':'I64'],
        '156' + '7.1': sheet_form['K63':'N64'],
        '156' + '8.0': sheet_form['P63':'S64'],
        '173' + '5.6': sheet_form['A68':'D69'],
        '173' + '6.3': sheet_form['F68':'I69'],
        '173' + '7.1': sheet_form['K68':'N69'],
        '193' + '6.3': sheet_form['A73':'D77'],
        '193' + '7.1': sheet_form['F73':'I77'],
        '193' + '8.0': sheet_form['K73':'N77'],
        '193' + '9.0': sheet_form['P73':'S77'],
        '194' + '5.6': sheet_form['A81':'D85'],
        '194' + '6.3': sheet_form['F81':'I85'],
        '194' + '7.1': sheet_form['K81':'N85'],
        '194' + '8.0': sheet_form['P81':'S85'],
        '215' + '6.3': sheet_form['A89':'D90'],
        '215' + '7.1': sheet_form['F89':'I90'],
        '215' + '8.0': sheet_form['K89':'N90'],
        '234' + '6.3': sheet_form['A94':'D98'],
        '234' + '7.1': sheet_form['F94':'I98'],
        '234' + '8.0': sheet_form['K94':'N98'],
        '240' + '7.1': sheet_form['A102':'D106'],
        '240' + '8.0': sheet_form['F102':'I106'],
        '240' + '9.0': sheet_form['K102':'N106'],
        '271' + '6.3': sheet_form['A110':'D114'],
        '271' + '7.1': sheet_form['F110':'I114'],
        '271' + '8.0': sheet_form['K110':'N114'],
        '289' + '7.1': sheet_form['A118':'D122'],
        '289' + '8.0': sheet_form['F118':'I1224'],
        '289' + '9.0': sheet_form['K118':'N122'],
        '289' + '10.0': sheet_form['P118':'S122'],
        '290' + '6.3': sheet_form['A126':'D130'],
        '290' + '7.1': sheet_form['F126':'I130'],
        '290' + '8.0': sheet_form['K126':'N130'],
        '290' + '9.0': sheet_form['P126':'S130'],
        '333' + '7.1': sheet_form['A134':'D138'],
        '333' + '8.0': sheet_form['F134':'I138'],
        '337' + '8.0': sheet_form['A142':'D146'],
        '337' + '9.0': sheet_form['F142':'I146'],
        '350' + '7.1': sheet_form['A150':'D154'],
        '350' + '8.0': sheet_form['F150':'I154'],
        '350' + '9.0': sheet_form['K150':'N154'],
        '350' + '10.0': sheet_form['P150':'S154'],
        '350' + '11.2': sheet_form['U150':'X154'],
        '407' + '9.0': sheet_form['A158':'D162'],
        '407' + '10.0': sheet_form['F158':'I162'],
        '407' + '11.2': sheet_form['K158':'N162'],
        '407' + '12.5': sheet_form['P158':'S162'],
        '414' + '9.0': sheet_form['A166':'D170'],
        '414' + '10.0': sheet_form['F166':'I170'],
        '473' + '9.0': sheet_form['A174':'D178'],
        '473' + '10.0': sheet_form['F174':'I178'],
        '473' + '11.2': sheet_form['K174':'N178'],
        '473' + '12.5': sheet_form['P174':'S178'],
        '500' + '8.0': sheet_form['A182':'D186'],
        '500' + '9.0': sheet_form['F182':'I186'],
        '500' + '10.0': sheet_form['K182':'N186']
    }
    try:
...
def air_table(vrs_perf, air, vosk):
    ...
    air_list = {
        ...
        '6.3' + 'АИР80': sheet_form['A80':'D86'],
        '6.3' + 'АИР90': sheet_form['F80':'I86'],
        '6.3' + 'АИР100': sheet_form['K80':'N86'],
        '6.3' + 'АИР112': sheet_form['P80':'S86'],
        '6.3' + 'АИР132': sheet_form['U80':'X86'],
        '6.3' + 'АИР160': sheet_form['Z80':'AC86'],
        '6.3' + 'АИР180': sheet_form['AE80':'AH86'],
        '7.1' + 'АИР100': sheet_form['A90':'D96'],
        '7.1' + 'АИР112': sheet_form['F90':'I96'],
        '7.1' + 'АИР132': sheet_form['K90':'N96'],
        '7.1' + 'АИР160': sheet_form['P90':'S96'],
        '7.1' + 'АИР180': sheet_form['U90':'X96'],
        '7.1' + 'АИР200': sheet_form['Z90':'AC96'],
        '8.0' + 'АИР100': sheet_form['A100':'D106'],
        '8.0' + 'АИР112': sheet_form['F100':'I106'],
        '8.0' + 'АИР132': sheet_form['K100':'N106'],
        '8.0' + 'АИР160': sheet_form['P100':'S106'],
        '8.0' + 'АИР180': sheet_form['U100':'X106'],
        '8.0' + 'АИР200': sheet_form['Z100':'AC106'],
        '8.0' + 'АИР225': sheet_form['AE100':'AH106'],
        '8.0' + 'Mot180': sheet_form['AJ100':'AM106']
    }
    try:
