...
class VRS:
    def __init__(self, width, height, title="MyWindow", resizable=(False, False), icon=r"resourses/icon.ico"):
        ...
        self.air = Combobox(self.root, values=("АИР56", "АИР64", "АИР71", "АИР80", "АИР90", "АИР100", "АИР112",
                                               "АИР132", "АИР160", "АИР180", "АИР225", "АИР250"), width=7, state="readonly")
        self.air2 = Combobox(self.root, values=("АИР56", "АИР64", "АИР71", "АИР80", "АИР90", "АИР100", "АИР112",
                                                "АИР132", "АИР160", "АИР180", "АИР225", "АИР250"), width=7, state="readonly")
    ...
    def draw_widgets(self):
        ...
        Checkbutton(self.root, text="Блок вентилятора ВОСК", justify=LEFT, variable=self.ventbox).grid(row=4,
        ...
        Checkbutton(self.root, text="Блок вентилятора ВОСК 2", justify=LEFT, variable=self.vent2box).grid(row=5,
                                                                                                          column=0, sticky=W)  # строка чекбокса
        ...
        Checkbutton(self.root, text="Блок ВНВ 5012", justify=LEFT, variable=self.vnv5012box).grid(row=6, column=0,
        ...
        Checkbutton(self.root, text="Блок ВОВ 5012", justify=LEFT, variable=self.vov5012box).grid(row=7, column=0,
                                                                                                  sticky=W)     # строка чекбокса
        ...
        Checkbutton(self.root, text="Блок вертикального клапана", justify=LEFT, variable=self.vertklapbox).grid(
            row=10, column=0, sticky=W)  # строка чекбокса
        self.entryvertklap.grid(row=10, column=1, columnspan=2, sticky=W)
        Checkbutton(self.root, text="Блок пластинчатого утилизатора", justify=LEFT, variable=self.ppbox).grid(
            row=11, column=0, sticky=W)  # строка чекбокса
        self.entrypp.grid(row=11, column=1, columnspan=2, sticky=W)
        Checkbutton(self.root, text="Блок камеры промежуточной",justify=LEFT,variable=self.promkambox).grid(row=12,
                                                                                                            column=0, sticky=W)  # строка чекбокса
        ...
        Button(self.root, width=6, height=2, text="Закрыть", command=self.root.destroy).grid(row=13, column=1,
                                                                                             columnspan=2, sticky=W+E)                           # Кнопка закрытия
   ...
   #         self.root.destroy()
    ...
    def action(self):
        ...
        if self.ventbox.get():
            ...
            cells = vent_table(vrs_num, vrs_perf)
            for sign, name, amount, material in cells:
